...
namespace Ritterg\SruAo\ServiceProviders;

use Illuminate\Support\ServiceProvider;
use Ritterg\SruAo\Contracts\SampleInterface;
use Ritterg\SruAo\Facades\SampleFacadeAccessor;
use Ritterg\SruAo\Sample;

/**
 * Class SruAoServiceProvider
 *
 * @author Gerold Ritter <ritter@e-hist.ch>
 */
Class SruAoServiceProvider extends ServiceProvider
{
